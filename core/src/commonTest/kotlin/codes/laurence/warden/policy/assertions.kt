...
import codes.laurence.warden.policy.expression.AttributePathSegment
...
fun assertLeftOperand(policy: ExpressionPolicy, expectedType: AttributeType, expectedPath: List<AttributePathSegment>) {
